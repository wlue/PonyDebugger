...
// Callback Param internalProperties: Internal object properties.
- (void)domain:(PDRuntimeDomain *)domain getPropertiesWithObjectId:(NSString *)objectId ownProperties:(NSNumber *)ownProperties callback:(void (^)(NSArray *result, NSArray *internalProperties, id error))callback;
